...
public class ProjectController {
    ...
    public List<Project> listProject(OAuth2Authentication authentication){
    	System.out.println(tokenServices.getAccessToken(authentication).getAdditionalInformation().get("projects"));
    ...
    public ResponseEntity<?> someResource(OAuth2Authentication authentication) {
        ...
        Set<String> customInfo =  (Set<String>) additionalInfo.get("projects");
